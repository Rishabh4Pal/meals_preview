...
class FiltersScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final changedFilters = ref.watch(filterProvider);
    return Scaffold(
      appBar: AppBar(
      ...
      body: Column(
        children: [
          SwitchListTile(
            value: changedFilters[Filter.glutenFree]!,
            onChanged: (isChecked) {
          ...
          SwitchListTile(
            value: changedFilters[Filter.lactoseFree]!,
            onChanged: (isChecked) {
          ...
          SwitchListTile(
            value: changedFilters[Filter.vegetarian]!,
            onChanged: (isChecked){
          ...
          SwitchListTile(
            value: changedFilters[Filter.vegan]!,
            onChanged: (isChecked) {
